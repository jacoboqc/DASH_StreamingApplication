...
if [ -f "${fsrt}" ]; then #if srt file exists, add captions
MP4Box -add "${fsrt}.srt" "tmp/${f}_350.mp4"
MP4Box -add "${fsrt}.srt" "tmp/${f}_650.mp4"
MP4Box -add "${fsrt}.srt" "tmp/${f}_1400.mp4" 
MP4Box -add "${fsrt}.srt" "tmp/${f}_2500.mp4"
MP4Box -add "${fsrt}.srt" "tmp/${f}_5500.mp4"
